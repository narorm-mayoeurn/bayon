...
<head>
    ...
    <!-- iCheck -->
    <link rel="stylesheet" href="/template/adminlte/plugins/iCheck/square/blue.css">
...
<div class="login-box">
    <div class="login-logo">
        <a href="/template/adminlte/index2.html"><b>Antioch</b>School</a>
    </div>
    <!-- /.login-logo -->
    <div class="login-box-body">
        <p class="login-box-msg">Sign in to start your session</p>

        <form action="/template/adminlte/index2.html" method="post">
