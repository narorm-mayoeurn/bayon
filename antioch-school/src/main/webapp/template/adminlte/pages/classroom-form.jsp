                    ...
                    <form class="form-horizontal" id="class_form" action="/classes/save" method="post">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                <label for="room_no" class="col-sm-3 control-label">Class Name</label>
                                <div class="col-sm-9">
                                    <input type="text" class="form-control" id="name" name="name" value="<%= clazz == null ? "" : clazz.getName()%>">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                <textarea class="form-control" id="description" rows="3" name="description"><%= clazz == null ? "" : clazz.getDescription()%></textarea>
                                </div>
                            </div>

                            <div class="form-group">
                                <label for="session" class="col-sm-3 control-label">Program</label>
                                <div class="col-sm-9">
                                <select class="form-control" id="description" rows="3" name="programId" placeholder="Select ...">
                                    <%
                            ...
                            <div class="form-group">
                                <label for="session" class="col-sm-3 control-label">Teacher</label>
                                <div class="col-sm-9">
                                <select class="form-control" id="description" rows="3" name="teacherId" placeholder="Select ...">
                                    <%
